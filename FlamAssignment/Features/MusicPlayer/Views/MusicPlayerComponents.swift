            ...
            VStack(alignment: .trailing, spacing: 6) {
                ...
                if isCurrentSong {
                    Image(systemName: "speaker.wave.2.fill")
                        .font(.system(size: 14, weight: .medium))
                        .foregroundColor(Color.dynamicAccent(for: Song(title: song.title, artist: song.artist, duration: song.duration, source: song.source)))
                        .scaleEffect(1.1)
                ...
                ZStack {
                    Circle()
                        .fill(
                            LinearGradient(
                                gradient: Gradient(colors: [
                                    musicManager.currentSong == nil ? Color.gray : Color.dynamicAccent(for: musicManager.currentSong),
                                    musicManager.currentSong == nil ? Color.gray.opacity(0.8) : Color.dynamicAccent(for: musicManager.currentSong).opacity(0.8)
                                ]),
                                startPoint: .topLeading,
                                endPoint: .bottomTrailing
                            )
                ...
                GeometryReader { geometry in
                    ZStack(alignment: .leading) {
                        ...
                        RoundedRectangle(cornerRadius: 3)
                            .fill(
                                LinearGradient(
                                    gradient: Gradient(colors: [Color.dynamicAccent(for: musicManager.currentSong), Color.dynamicAccent(for: musicManager.currentSong).opacity(0.8)]),
                                    startPoint: .leading,
                                    endPoint: .trailing
                                )
                            )
                        ...
                        // Thumb
                        Circle()
                            .fill(Color.dynamicAccent(for: musicManager.currentSong))
