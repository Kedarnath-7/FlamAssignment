...
class MockSocialFeedService: SocialFeedServiceProtocol {
    ...
    private func createMockPosts(users: [User]) -> [Post] {
        ...
        mockPosts.append(Post(
            user: users[3],
            type: .video,
            content: "Here's a quick tutorial on implementing MVVM with Combine! Good for beginners 📱👨‍💻",
        ...
        for i in 4..<50 {
            ...
            let baseContent = [
                "Building great iOS apps with modern technology! 📱",
